...
1) molecule files or multi-molecule file in a format/file extension that Open Babel understands
2) an sql file (called dirname.sql) describing the source for import into the db, like so:
